...
impl<'p> Runner<'p> {
    pub fn eval_bridged(self, index: u16) -> Value {
        ...
        match index {
            0 => calc!(+, self.params.clone_param(0), self.params.clone_param(1)),
            1 => calc!(-, self.params.clone_param(0), self.params.clone_param(1)),
            2 => calc!(*, self.params.clone_param(0), self.params.clone_param(1)),
            3 => calc!(/, self.params.clone_param(0), self.params.clone_param(1)),
            4 => {
